...
_parser.add_argument('--arch', type=str, default='MMoE',
                     help='architecture for MTL, option: HPS, MTAN')
_parser.add_argument('--rep_grad', action='store_true',
                     help='computing gradient for representation or sharing parameters')
_parser.add_argument('--multi_input', action='store_false',
...
_parser.add_argument('--lr', type=float, default=0.001, help='learning rate for all types of optim')
_parser.add_argument('--momentum', type=float, default=0.9, help='momentum for sgd')
_parser.add_argument('--weight_decay', type=float, default=0, help='weight decay for all types of optim')
## scheduler
...
## CGC
_parser.add_argument('--img_size', nargs='+', default=[128], help='image size for CGC')
_parser.add_argument('--num_experts', nargs='+', default=[5, 5, 5, 5],
